...
<html lang="en">
    ...
    <body>
                            ...
                            <form method="Post" action="RegisterServlet" class="register-form"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="re_pass" id="re_pass"
                                           placeholder="Repeat Your assword" required="required" />
                                </div>
                                <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            if (status == "InvalidUrepwd") {
                swal("Sorry", "Password conformation is wrong", "error");
            }
            if (status == "InvalidUmobile") {
                swal("Sorry", "Invalid Mobile Number", "error");
            }
            if (status == "InvalidUmobileLength") {
                swal("Sorry", "Mobile Number length should be of 10 digits", "error");
            }
        </script>
